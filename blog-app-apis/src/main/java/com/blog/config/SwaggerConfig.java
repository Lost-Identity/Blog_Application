...
public class SwaggerConfig {
	...
	private ApiInfo getInfo() {
		...
		return new ApiInfo("Blog_Application", "This project is developed by Ajay Patidar", "1.0", "Terms of Service", new Contact("Ajay Patidar", "http/ajay.in", "patidarajay769@gmail.com"), 
